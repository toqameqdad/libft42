...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2025/11/30 22:06:20 by tmeqdad           #+#    #+#              #
#    Updated: 2025/11/30 22:07:02 by tmeqdad          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = \
	...
	ft_strlen.c ft_strlcpy.c ft_strlcat.c ft_strchr.c ft_strrchr.c ft_strnstr.c ft_strncmp.c ft_strdup.c ft_calloc.c \
	ft_substr.c ft_strjoin.c ft_strtrim.c ft_split.c ft_itoa.c ft_strmapi.c ft_striteri.c ft_atoi.c \
